...
def sample_recipe(user, **params):
    ...
    #**default converts the dictionary into params
...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_recipe_with_ingredients(self):
        """Test creating recipe with ingrediemts"""
        ingredient1 = sample_ingredient(user=self.user, name='Nuez')
